...
#define SYMPHONY_SCREEN_WIDTH = 1680.0
#define SYMPHONY_SCREEN_TOTAL_WIDTH = 8880.0
#define SYMPHONY_SCREEN_TOTAL_HEIGHT = 5560.0
#define SYMPHONY_SCREEN_GAP = 120.0
