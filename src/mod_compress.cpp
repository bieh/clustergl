...
{
	if(gConfig->compressingMethod == 2 || gConfig->compressingMethod == 3) {
...
int NetCompressModule::myCompress(void *input, int nByte, void *output)
{
	...
	if(nByte > 4) {
		...
		else if(gConfig->compressingMethod == 2)
